...
public class LocationActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		map.setOnMapClickListener(new OnMapClickListener() {
			...
			public boolean onMapPoiClick(MapPoi result) {
				// TODO Auto-generated method stub
				Toast.makeText(LocationActivity.this, result.getName(), 0)
						.show();
				return false;
			}
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
		case R.id.btn_start:
			Toast.makeText(LocationActivity.this, "点击兴趣点，选择提点", 0).show();
			dismissPopupWindow();
			baiDuMap.setOnMapClickListener(new OnMapClickListener() {
				...
				public boolean onMapPoiClick(MapPoi poi) {
					...
					Toast.makeText(LocationActivity.this, startName, 0).show();
			...
			break;
		case R.id.btn_end:
			Toast.makeText(LocationActivity.this, "点击兴趣点，选择终点", 0).show();
			dismissPopupWindow();
			baiDuMap.setOnMapClickListener(new OnMapClickListener() {
				...
				public boolean onMapPoiClick(MapPoi poi) {
					...
					Toast.makeText(LocationActivity.this, name, 0).show();
					ed_end.setText(name);
					return true;
				}
		...
		case R.id.ll_location:
			...
			Toast.makeText(LocationActivity.this, addStr, 0).show();
			dismissPopupWindow();
			break;
		case R.id.ll_detail:
			ll_title.setVisibility(View.GONE);
			// 获取LayoutInflater实例
			inflater = (LayoutInflater) LocationActivity.this
					.getSystemService(LocationActivity.this.LAYOUT_INFLATER_SERVICE);
			// 获取弹出菜单的布局
		...
		case R.id.btn_search:
			...
			if (TextUtils.isEmpty(start) || TextUtils.isEmpty(end)) {
				Toast.makeText(LocationActivity.this, "请输入起点或者终点", 0).show();
			}
			if (flag == 1) {
